...
function updateDessert(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var transaction, key, dessert, entity;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [2 /*return*/, res.status(200).send('CORS: OPTIONS request')];
                case 1:
                    if (!(req.method === 'PUT')) return [3 /*break*/, 3];
                    transaction = datastore.transaction();
                    key = datastore.key([kindName, req.body.id]);
                    return [4 /*yield*/, transaction.get(key)];
                case 2:
                    dessert = (_a.sent())[0];
...
exports.updateDessert = updateDessert;
;
